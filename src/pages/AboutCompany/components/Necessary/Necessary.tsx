            ...
            <div className={gStyles.container}>
                <div className={styles.wrapper}>
                    ...
                    <ul className={styles.list}>
                        <ItemChoose to={ABOUT_COMPANY.requisite} image={iconNecessary1} footer={<p>АПТЕКА</p>} />
                        <ItemChoose to={ABOUT_COMPANY.requisite} image={iconNecessary2} footer={<p>Ветеренарная аптека</p>} />
                        <ItemChoose to={ABOUT_COMPANY.requisite} image={iconNecessary3} footer={<p>ВМедицинская техника и товары</p>} />
                    </ul>
                </div>
            </div>
        </div>
