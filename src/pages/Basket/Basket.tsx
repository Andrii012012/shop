    ...
    return (
        <main className={styles.page}>
            <div className={gStyles.container}>
                ...
                <SwitchContent disabled={[{ index: 0, color: "" }, { index: 1, color: isRecipeProduct ? "" : "#7F7F7F" }, { index: 2, color: '' }]} links={[{ name: SWITCH_CONTENT[0], to: `${PATH_BASKET}/${SWITCH_CONTENT[0]}` }, { name: SWITCH_CONTENT[1], to: `${PATH_BASKET}/${SWITCH_CONTENT[1]}` }, { name: SWITCH_CONTENT[2], to: `${PATH_BASKET}/${SWITCH_CONTENT[2]}` }]} />
            </div>
            <Routes>
